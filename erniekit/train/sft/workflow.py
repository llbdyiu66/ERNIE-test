...
from paddleformers.transformers import Ernie4_5Config, Ernie4_5ForCausalLM, Ernie4_5Tokenizer
...
def run_sft(
    ...
    # with hf
    print(f'convert_from_hf: {trainer.args.convert_from_hf}, save_to_hf: {trainer.args.save_to_hf}')
